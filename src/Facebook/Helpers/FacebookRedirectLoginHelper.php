...
class FacebookRedirectLoginHelper
{
     ...
     */
    public function __construct(OAuth2Client $oAuth2Client, PersistentDataInterface|null $persistentDataHandler = null, UrlDetectionInterface|null $urlHandler = null, PseudoRandomStringGeneratorInterface|null $prsg = null)
    {
