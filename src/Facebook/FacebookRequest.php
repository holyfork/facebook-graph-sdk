...
class FacebookRequest
{
     ...
     */
    public function __construct(FacebookApp|null $app = null, $accessToken = null, $method = null, $endpoint = null, array $params = [], $eTag = null, $graphVersion = null)
    {
        $this->setApp($app);
     ...
     * @param FacebookApp|null $app
     */
    public function setApp(FacebookApp|null $app = null)
    {
        $this->app = $app;
    }
